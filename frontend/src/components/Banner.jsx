...
const Banner = () => {
    ...
    return (
        <div className='flex bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white p-6 rounded-xl  px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
